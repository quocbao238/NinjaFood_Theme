...
class AppIcons extends StatelessWidget {
  ...
  const AppIcons.facebook({super.key, this.color}) : _urlIcon = AppIconsAssets.facebook;
  ...
  const AppIcons.payOneer({super.key, this.color}) : _urlIcon = AppIconsAssets.payOneer;
  ...
  @override
  Widget build(BuildContext context) => SvgPicture.asset(_urlIcon, package: 'ninja_theme', semanticsLabel: 'App Icon');
}
